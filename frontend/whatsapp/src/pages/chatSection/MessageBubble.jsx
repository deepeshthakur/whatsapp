    ...
    <div className={`chat ${bubbleClass}`}>
      <div className={`${bubbleContentClass} relative group`} ref={messageRef}>
        ...
        <div className="self-end flex items-center justify-end gap-1 text-xs opacity-60 mt-2 ml-2">
          ...
          {isUserMessage && (
            <>
              {message.messsageStatus === "send" && <FaCheck size={12} />}
              {message.messsageStatus === "delivered" && (
                <FaCheckDouble size={12} />
              )}
              {message.messsageStatus === "read" && (
        ...
        {showReactions && (
          <div
            ...
            } transform -translate-x-1/2 flex items-center bg-[#202c33]/90 rounded-full px-2 py-1.5 gap-1 shadow-lg z-15`}
          >
        ...
        {showEmojiPicker && (
          <div
            ref={emojiPickerRef}
            className="absolute flex left-0 right-0 mb-6 z-50"
          >
        ...
        {showOptions && (
          <div
            className={`absolute top-0 right-1 z-50 w-36 rounded-xl shadow-lg py-2 text-sm ${
              theme === "dark"
